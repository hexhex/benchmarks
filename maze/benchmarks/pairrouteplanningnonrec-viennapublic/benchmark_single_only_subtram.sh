...
do
	...
	dir=$PWD
	cd ..
	cmd="timeout $to time -o $dir/$instance.$i.time.dat -f %e dlvhex2 $c --heuristics=easy --plugindir=../../src --extlearn --evalall -n=1 map_only_subtram.hex $dir/$instance --verbose=8"
