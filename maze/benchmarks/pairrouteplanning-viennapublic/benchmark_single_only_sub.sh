...
do
	...
	cmd="timeout $to time -o $dir/$instance.$i.time.dat -f %e dlvhex2 --claspconfig=\"$frumpy\" $c --plugindir=../../src --extlearn --evalall -n=1 map_only_sub.hex $dir/$instance.$i.mc $dir/$instance --verbose=8 --silent"
