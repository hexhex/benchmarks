...
#define PACKAGE_TARNAME "Sensor"
#define LEGGEDLOCOMOTIONPLUGIN_VERSION_MAJOR 2
#define LEGGEDLOCOMOTIONPLUGIN_VERSION_MINOR 0
#define LEGGEDLOCOMOTIONPLUGIN_VERSION_MICRO 0
